                                ...
                                <ul class="entry-comments-list list-unstyled">
                                    ...
                                    <li>
                                        <div class="entry-comments-item">
                                            ...
                                            <button class="btn"><a class="Manager" href="index.php?action=removeComment&amp;comment_id=<?= $comment['comment_id']; ?>" onclick="return confirm('Etes vous sûr de vouloir supprimer ce commentaire ?');">Supprimer le commentaire</a></button>
                                        </div>
                                    </li>
